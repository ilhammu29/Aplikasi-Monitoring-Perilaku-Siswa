<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.kelola-pengguna')" :active="request()->routeIs('admin.kelola-pengguna')">
                        {{ __('Kelola Pengguna') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.kategori-perilaku.index')" :active="request()->routeIs('admin.kategori-perilaku.*')">
                    ...
                    <x-nav-link :href="route('guru.daftar-siswa')" :active="request()->routeIs('guru.daftar-siswa')">
                        {{ __('Daftar Siswa') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('orangtua.semua-perilaku')" :active="request()->routeIs('orangtua.semua-perilaku')">
                        {{ __('Perilaku Siswa') }}
                    </x-nav-link>
                    @endif
                    @endauth
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.kelola-pengguna')" :active="request()->routeIs('admin.kelola-pengguna')">
                {{ __('Kelola Pengguna') }}
            </x-responsive-nav-link>
            @elseif(auth()->user()->role === 'guru')
            ...
            <x-responsive-nav-link :href="route('guru.daftar-siswa')" :active="request()->routeIs('guru.daftar-siswa')">
                {{ __('Daftar Siswa') }}
            </x-responsive-nav-link>
            @elseif(auth()->user()->role === 'siswa')
            ...
            @elseif(auth()->user()->role === 'orang_tua')
            <x-responsive-nav-link :href="route('orangtua.dashboard')" :active="request()->routeIs('orangtua.dashboard')">
                {{ __('Dashboard Orang Tua') }}
            </x-responsive-nav-link>
            @endif
            @endauth
